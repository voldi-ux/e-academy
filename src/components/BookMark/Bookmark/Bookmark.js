    ...
    <div className='bookmark'>
       ...
       <div className='first-content'>
        ...
        <div className='illustrate'>
          <img src={illustration} alt="" className="illustrate" />
        </div>
        ...
        <div className='bookmark-content'>
           <h2 style={{color:"var(--grey"}}>{name} Gr.12</h2> 
           <small style={{fontSize:"12px", fontWeight:"bold", color:"var(--grey)"}}>Mathematics : Calculus </small>
...
{
    name: "Voldi Muyumba",
    description: "What does the tangent line of the graph below tell us about gradient? do we only focus on the red point or can we get a geral gradient as well?",
